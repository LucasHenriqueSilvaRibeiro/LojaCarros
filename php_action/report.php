...
<div class="btn-large orange right">
    <!--Não consegui trocar a cor do texto de dentro-->
    <a href="" class="text-white" onclick="window.print()">Imprimir</a>
</div>
...
<div class="selection no-pad-bot" id="index-banner">
    <div class="container">
        ...
        <img src="../assets/images/logorelatorio.png" width="400"/>
